...
/* IDLE TASK */
static __far StaticTask_t __align(4) xIdleTaskTBC;
static __far StackType_t __align(4) xIdleTaskStack[configMINIMAL_STACK_SIZE];
#if (configUSE_TIMERS == 1)
/* TIMER TASKS */
static __far StaticTask_t __align(4) xTimerTaskTBC;
static __far StackType_t __align(4) xTimerTaskStack[configTIMER_TASK_STACK_DEPTH];
...
{
	*ppxIdleTaskTCBBuffer = &xIdleTaskTBC;
...
{
	*ppxTimerTaskTCBBuffer = &xTimerTaskTBC;
