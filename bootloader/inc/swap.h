...
extern void do_swap( void );
extern uint8 get_currentBank( void );

/*!
 * \brief Writes enable Swap configuration if off.
 */
extern void enable_swap( void );

/*!
 * \brief Writes disable Swap configuration.
 */
extern void disable_swap( void );

/*!
 * \brief Configures UCB_SWAP_COPY and UCB_SWAP_COPY accordingly.
 */
extern void configure_swap(uint32 map);
