...
#ifndef BOOTLOADER_FLASH_H_
#define BOOTLOADER_FLASH_H_
...
#define PFLASH_LOGICAL_SECTOR_SIZE  0x4000			//16Kbyte
...
void pfls_MassErase( uint32 pfls_addr );;
